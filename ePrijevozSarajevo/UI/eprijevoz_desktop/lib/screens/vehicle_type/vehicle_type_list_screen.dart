...
import 'package:eprijevoz_desktop/screens/vehicle_type/vehicle_type_add_screen.dart';
import 'package:eprijevoz_desktop/screens/vehicle_type/vehicle_type_update_screen.dart';
...
class _VehicleTypeListScreenState extends State<VehicleTypeListScreen> {
  ...
  Future refreshTable() async {
    ...
    try {
      ...
      typeResult = await typeProvider.get(filter: request);
    } catch (e) {
      debugPrint('Error: $e');
    } finally {
      setState(() {
  ...
  final TextEditingController _ftsTypeController = TextEditingController();
  ...
  Widget _buildSearch() {
    return Row(
      children: [
        ...
        Expanded(
          child: TextFormField(
            controller: _ftsTypeController,
            cursorColor: Colors.green.shade800,
            decoration: InputDecoration(
              suffixText: 'Pretraga po tipu vozila.',
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            try {
              var filter = {
                'NameGTE': _ftsTypeController.text,
              };
              typeResult = await typeProvider.get(filter: filter);
            } catch (e) {
              debugPrint('Error: $e');
            } finally {
              setState(() {
