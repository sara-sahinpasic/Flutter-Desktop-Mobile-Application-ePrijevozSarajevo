...
class CountryUpdateDialog extends StatefulWidget {
  final Country country;
  final Function onDone;
  const CountryUpdateDialog(
      {required this.country, required this.onDone, super.key});

  @override
  State<CountryUpdateDialog> createState() => _CountryUpdateDialogState();
}

class _CountryUpdateDialogState extends State<CountryUpdateDialog> {
                                ...
                                if (_formKey.currentState?.saveAndValidate() ??
                                  ...
                                  try {
                                    await countryProvider.update(
                                        widget.country.countryId!, request);
