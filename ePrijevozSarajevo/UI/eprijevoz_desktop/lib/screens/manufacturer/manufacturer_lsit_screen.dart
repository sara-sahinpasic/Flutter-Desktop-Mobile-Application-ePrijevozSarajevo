...
import 'package:eprijevoz_desktop/screens/manufacturer/manufacturer_add_screen.dart';
import 'package:eprijevoz_desktop/screens/manufacturer/manufacturer_update_screen.dart';
...
class _ManufacturerListScreenState extends State<ManufacturerListScreen> {
  ...
  Future refreshTable() async {
    ...
    try {
      ...
      manufacturerResult = await manufacturerProvider.get(filter: request);
    } catch (e) {
      debugPrint('Error: $e');
    } finally {
      setState(() {
  ...
  final TextEditingController _ftsManufacturerNameController =
  ...
  Widget _buildSearch() {
    return Row(
      children: [
        ...
        Expanded(
          child: TextFormField(
            controller: _ftsManufacturerNameController,
            cursorColor: Colors.green.shade800,
            decoration: InputDecoration(
              suffixText: 'Pretraga po nazivu proizvođača.',
        ...
        ElevatedButton(
          onPressed: () async {
            ...
            try {
              var filter = {
                'NameGTE': _ftsManufacturerNameController.text,
              };
              manufacturerResult =
                  await manufacturerProvider.get(filter: filter);
            } catch (e) {
              debugPrint('Error: $e');
            } finally {
              setState(() {
            ...
            _ftsManufacturerNameController.clear();
          },
                ...
                children: [
                  Container(
                    ...
                    child: DataTable(
                      ...
                      rows: manufacturerResult?.result
                              .map(
                                (e) => DataRow(
                                  cells: [
                                    DataCell(Text(
