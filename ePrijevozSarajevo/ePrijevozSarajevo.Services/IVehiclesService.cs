...
{
    public interface IVehiclesService : ICRUDService<Vehicle, VehicleSearchObject, VehicleInsertRequest, VehicleUpdateRequest>
        //IService<Model.Vehicle, VehicleSearchObject>
    {
        //Vehicle
