...
{
    public class VehiclesService : BaseCRUDService<Model.Vehicle, VehicleSearchObject, Database.Vehicle, VehicleInsertRequest, VehicleUpdateRequest>, IVehiclesService
    //BaseService<Model.Vehicle, VehicleSearchObject, Database.Vehicle>
    {
